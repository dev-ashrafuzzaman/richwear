...
/*
  AsyncSelect (Optimized)
  ----------------------
  loadOptions(search, page, limit) => Promise<Option[]>

  Option shape (recommended):
  {
    label: string,
    value: string,
    raw?: any
...
export default function AsyncSelectPos({
  label,
  placeholder = "Search...",
  loadOptions,
